    ...
    <div className="p-5  w-full  lg:px-60 py-20 text-black h-auto  bg-accent1 ">
        ...
        <div className = "w-full grid lg:grid-cols-2">
            ...
            <div className="w-1/2">
                ...
                <div className=" w-full flex justify-between lg:pt-0 pt-10 lg:justify-end mb-20 flex-row lg:gap-20">
                ...
                <ul className = "flex flex-col gap-3 "><p className="text-2xl  font-bold">WORKS</p>
